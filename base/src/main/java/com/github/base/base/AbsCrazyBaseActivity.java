...
import com.github.base.delegate.IActivity;
import com.github.base.integration.cache.Cache;
import com.github.base.integration.cache.CacheType;
import com.github.base.integration.lifecycle.ActivityLifecycleable;
...
import static com.github.base.utils.ThirdViewUtil.convertAutoView;

/**
 * @author admin
 */
public abstract class AbsCrazyBaseActivity<P extends ICrazyPresenter> extends AppCompatActivity implements IActivity, ActivityLifecycleable {
    ...
    public synchronized Cache<String, Object> provideCache() {
        if (mCache == null) {
            ...
            mCache = CrazyUtils.obtainAppComponentFromContext(this).cacheFactory().build(CacheType.ACTIVITY_CACHE);
        }
        return mCache;
    }
