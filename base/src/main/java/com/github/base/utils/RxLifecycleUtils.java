...
import com.github.base.integration.lifecycle.Lifecycleable;
...
public class RxLifecycleUtils {
     ...
     * @return
     */
    public static <T> LifecycleTransformer<T> bindUntilEvent(@NonNull final ICrazyView view,
     ...
     * @return
     */
    public static <T> LifecycleTransformer<T> bindToLifecycle(@NonNull ICrazyView view) {
        Preconditions.checkNotNull(view, "view == null");
