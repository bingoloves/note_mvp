...
import static com.github.base.common.Platform.DEPENDENCY_AUTO_LAYOUT;
import static com.github.base.delegate.ActivityDelegate.LAYOUT_FRAMELAYOUT;
import static com.github.base.delegate.ActivityDelegate.LAYOUT_LINEARLAYOUT;
import static com.github.base.delegate.ActivityDelegate.LAYOUT_RELATIVELAYOUT;

public class ThirdViewUtil {

    private static int HAS_AUTO_LAYOUT_META = -1;
    //0 说明 AndroidManifest 里面没有使用 AutoLauout 的 Meta, 即不使用 AutoLayout, 1 为有 Meta, 即需要使用
