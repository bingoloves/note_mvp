package com.github.base.integration.cache;
...
/**
 * @ClassName: CacheType
 * @Description: 构建 {@link Cache} 时,使用 {@link CacheType} 中声明的类型,来区分不同的模块, 从而为不同的模块构建不同的缓存策略
 * @Author: crazyandcoder
 * @email: lijiwork@sina.com
 * @CreateDate: 2020/6/11 6:24 AM
 * @UpdateUser: 更新者
 * @UpdateDate: 2020/6/11 6:24 AM
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
