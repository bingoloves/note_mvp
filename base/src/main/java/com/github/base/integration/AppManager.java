 ...
 */
package com.github.base.integration;
...
import static com.github.base.common.Platform.DEPENDENCY_SUPPORT_DESIGN;
...
public final class AppManager {
    private long lastStartActivityTime;//最近启动activity的时间间隔
    /**
    ...
    public void showSnackbar(String message, boolean isLong) {
        if (getCurrentActivity() == null && getTopActivity() == null) {
            LogUtils.d("mCurrentActivity == null when showSnackbar(String,boolean)");
            return;
        }
        Completable.fromAction(() -> {
            ...
            if (DEPENDENCY_SUPPORT_DESIGN) {
                ...
                CrazyUtils.makeText(mApplication, message);
            }
...
//        if (canStartActivity()) {
        ...
        if (getTopActivity() == null) {
             LogUtils.d("mCurrentActivity == null when startActivity(Intent)");
...
//        if (canStartActivity()) {
        ...
        getTopActivity().startActivity(intent, bundle);
        getTopActivity().overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
//        }
    }
    ...
    public void startActivity(Class activityClass, int flag) {
        if (canStartActivity()) {
            Intent intent = new Intent(mApplication, activityClass);
    ...
    public void startActivity(Class activityClass, Bundle bundle) {
        if (canStartActivity()) {
            startActivity(new Intent(mApplication, activityClass), bundle);
        }
    }
    ...
    public Activity getTopActivity() {
        if (mActivityList == null) {
             LogUtils.d("mActivityList == null when getTopActivity()");
            return null;
        }
    ...
    public void removeActivity(Activity activity) {
        if (mActivityList == null) {
             LogUtils.d("mActivityList == null when removeActivity(Activity)");
            return;
        }
        synchronized (AppManager.class) {
    ...
    public Activity removeActivity(int location) {
        if (mActivityList == null) {
             LogUtils.d("mActivityList == null when removeActivity(int)");
            return null;
        }
        synchronized (AppManager.class) {
    ...
    public void killActivity(Class<?> activityClass) {
        if (mActivityList == null) {
             LogUtils.d("mActivityList == null when killActivity(Class)");
            return;
        }
        synchronized (AppManager.class) {
    ...
    public boolean activityInstanceIsLive(Activity activity) {
        if (mActivityList == null) {
             LogUtils.d("mActivityList == null when activityInstanceIsLive(Activity)");
            return false;
        }
    ...
    public boolean activityClassIsLive(Class<?> activityClass) {
        if (mActivityList == null) {
             LogUtils.d("mActivityList == null when activityClassIsLive(Class)");
            return false;
        }
    ...
    public Activity findActivity(Class<?> activityClass) {
        if (mActivityList == null) {
             LogUtils.d("mActivityList == null when findActivity(Class)");
            return null;
        }
        for (Activity activity : mActivityList) {
            if (activity.getClass().equals(activityClass)) {
...
//        }
    ...
    private boolean canStartActivity() {
        return System.currentTimeMillis() - lastStartActivityTime > 500;
